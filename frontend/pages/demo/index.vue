    ...
    <v-col cols="12">
      ...
      <v-row justify="center">
        <v-col sm="12" md="8" lg="6" align="start" justify="start">
          <v-row align="start">
            <v-col cols="12" sm="12">
              <v-text-field rounded outlined label="Log message" v-model="log.message"
              ></v-text-field>
            </v-col>
            <v-col cols="12" sm="12">
              <v-select rounded outlined :items="levels" v-model="log.level" label="Log level"
              ></v-select>
            </v-col>
            <v-col cols="5" sm="5">
              <v-text-field rounded outlined label="Business Property" v-model="business.key"
                            prepend-icon="mdi-format-list-bulleted-square"
              ></v-text-field>
            </v-col>
            <v-col cols="5" sm="5">
              <v-text-field rounded outlined label="Value" v-model="business.value"
              ></v-text-field>
            </v-col>
            <v-col cols="2" sm="2">
              <v-btn class="mt-2" @click="addBusiness" color="primary" style="color: white">
                Add property
              </v-btn>
            </v-col>
          </v-row>
      ...
      >
        <v-list-item three-line>
          <v-list-item-content>
            ...
            <v-list-item-subtitle>{{ log.businessProperties }}</v-list-item-subtitle>
          </v-list-item-content>
